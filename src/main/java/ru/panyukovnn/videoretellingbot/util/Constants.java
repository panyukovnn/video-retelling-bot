...
public class Constants {
    ...
    public static final String START_MESSAGE =
        ...
        + "Оплата:\n"
        + "Один бесплатный пересказ в день. Дополнительные пересказы — 100 звёзд Telegram за пакет из 50.\n"
        + "Для покупки звёзд из РФ можно воспользоваться ботом @PremiumBot — он принимает российские карты";
    public static final String START_MESSAGE_FEEDBACK_SUFFIX = "\n\nЕсли есть пожелания или жалобы — оставьте отзыв: %s";
