...
- Добавить в стартовое сообщение информацию о том как купить звезды из рф
- Добавить в стартовое сообщение ссылку на форму жалоб и предложений
- Исправить, чтобы от не отвечал на вопрос: “Кто ты?” - deepseek
- Добавить многопоточную обработку входящих сообщений, сейчас все как будто в один поток работает
- Починить стартер - когда персказ слишком большой, стартер стримминга сообщения не понимает что нужно перейти к следующему сообщению и завершить текущее
